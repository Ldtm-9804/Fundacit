...
if (isset($_POST["sbtn"])) {
	...
	$to = "fundacitetrujillo@gmail.com";
    ...
    <section class="left-content">
     <h2><?php echo stripslashes($pageDetails["page_title"]); ?></h2>
      ...
      <form action="contact-us.php" method="post" name="f" onsubmit="return validateForm();">
        <div class="rows">
			<div class="label"><span style="color:#F00;">*</span>Nombre: </div>
        ...
        <div class="rows">
			<div class="label"><span style="color:#F00;">*</span>Asunto: </div>
			<div class="input-row" ><input name="your_subject" id="your_subject" type="text" class="textbox" autocomplete="off"></div>
		</div>
        
         <div class="rows">
			<div class="label"><span style="color:#F00;">*</span>Mensaje: </div>
